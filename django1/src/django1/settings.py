...
SOCIAL_AUTH_GOOGLE_PLUS_KEY = '45473264210-34p8ile8nqhs38drckuqlph76jtuc74h.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = '7KqCgaf2CvDs0PkkbQGyX4ZO'
...
INSTALLED_APPS = [
    ...
    'customlogin',
    'blog',
    #pip install social-auth-app-django 명령어로
    #모듈이 설치되있어야 사용가능
    'social_django',
]
...
#MEDIA_URL : URL주소로 파일 주소를 접근할 때 사용하는 URL을 저장하는변수

#127.0.0.1:8000/files/1.jpg로 시작하는 경로는 미디어파일을 불러오는 것으로
#판단함
MEDIA_URL = '/files/'
...
#현재프로젝트 폴더/files에 클라이언트가 업로드한 파일이 저장되도록 설정
MEDIA_ROOT = os.path.join(BASE_DIR, 'files')
#C:/files/폴더에 미디어파일이 저장되도록 설정
#MEDIA_ROOT = 'c:/files'
#c:/files/1.jpg
#MEDIA_URL과 MEDIA_ROOT를 설정한 뒤, 메인 URLConf에서 URL과
#하드웨어 경로를 매칭하는 작업을 수행해야함
